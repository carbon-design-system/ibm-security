...
import { Hover } from './ICAModule.stories';
...
4. **Bottom spacer:** The is a bottom spacer of 16px ($layout-01) included inside the module so additional modules can be placed directly on top.
