...
import {
  ...
  HeaderName,
  ICA,
  ICAModule as ICAModuleComponent,
  IconButtonBar,
...
const ICAModule = withBackground(ICAModuleComponent);
...
export const Detail = () => (
  <>
    <div
      className={`${settings.prefix}--col-span-16 ${settings.prefix}--subgrid ${settings.prefix}--css-grid`}
    >
      <div className={`${settings.prefix}--col-span-100`}>
      ...
      <div
        className={`${settings.prefix}--col-start-9 ${settings.prefix}--col-span-8`}
      >
        <DescriptionListModule>
          <TypeLayout>
            <TypeLayoutBody>
    ...
    <div
      className={`${settings.prefix}--col-span-16 ${settings.prefix}--subgrid`}
    >
      <div className={`${settings.prefix}--col-span-100`}>
