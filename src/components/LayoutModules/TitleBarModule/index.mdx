...
<Canvas>
  <Story
    id="patterns-layout-modules-titlebarmodule--default"
...
The title bar can also accept two type variants, sub-section title and section title, so you shouldn't supplement your own type style.

<img alt="`TitleBarModule` variants" src={variants} />

<Source id="patterns-layout-modules-titlebarmodule--variant" />

### Grid placement

Title bar modules can span between 4 and 8 columns, following the [narrow grid](https://react.carbondesignsystem.com/?path=/docs/grid--narrow) implementation.
