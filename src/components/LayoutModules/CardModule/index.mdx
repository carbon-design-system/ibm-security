...
The card module can be built using a combination of the `CardModule`, [grid](https://react.carbondesignsystem.com/?path=/docs/grid--narrow), and either the <LinkTo kind="components-card" story="default">`Card`</LinkTo>, <LinkTo kind="patterns-summarycard" story="with-primary-label">`SummaryCard`</LinkTo>, or [`Tile`](https://react.carbondesignsystem.com/?path=/docs/tile) components.

Everything passed in as a [render prop](https://reactjs.org/docs/render-props.html) child of `CardModule` will be rendered.

<Canvas>
  <Story
    id="patterns-layout-modules-cardmodule--default"
...
<Source id="patterns-layout-modules-cardmodule--variant" />
...
- <LinkTo kind="patterns-layout-modules-actionbarmodule" story="default">
    ActionBarModule
  </LinkTo>
