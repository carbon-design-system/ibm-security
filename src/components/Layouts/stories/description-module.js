...
const story = () => (
  <>
    <h2 className="bx--type-productive-heading-03 security--padding-top--layout-01 security--padding-bottom--layout-01 security--margin-top--layout-00 security--margin-bottom--layout-00">
      Primary section title: produtive-heading-03
    </h2>
    <h3 className="bx--type-productive-heading-01 security--padding-top--layout-01 security--padding-bottom--layout-01 security--margin-top--layout-00 security--margin-bottom--layout-00">
